...
import 'package:kanban_task_managemant/presentition/ui/dialogs/tasks/ontapTaskDialog.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<dynamic> onTap_dialog(BuildContext context, BoardsCompleteState state) {
    return showDialog(
                      context: context,
  ...
  SizedBox boardData(BuildContext context, BoardsCompleteState state) {
    ...
    return SizedBox(
      ...
      child: state.boardList == null ||
              ...
              state.boardList![_currentIndex].taskConditions!.isEmpty ||
                    ...
                    ElevatedButton(
                      onPressed: () {
                        showDialog(
                            context: context,
                            builder: (context) =>
                                AddNewBoardDialog(currentIndex: _currentIndex));
                      },
          ...
          ////   boardsni scroll qilganda xato bor keyin birinchi va 2 chi boardga taskcondition qoshilmayapti   ---done
          : ListView.builder(
              scrollDirection: Axis.horizontal,
              itemBuilder: (context, outerIndex) {
                if (outerIndex ==
                    state.boardList![_currentIndex].taskConditions!.length) {
                  return TextButton(
                    onPressed: () {
                      showDialog(
                          context: context,
                          builder: (context) =>
                              AddNewColumnDialog(currentIndex: _currentIndex));
                    },
                  ...
                  final taskCondition = state
                      .boardList![_currentIndex].taskConditions![outerIndex];
                  return SizedBox(
                    width: 280.w,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemCount: taskCondition.taskItem?.length ?? 0,
                            ),
                          ),
                        ],
                      ),
              ...
              itemCount:
                  state.boardList![_currentIndex].taskConditions!.length + 1,
            ),
    );
  }
}
